...
fn test_messages() {
    let mut alive = plugins::alive::Plugin::new();
let mut system_monitor = plugins::system_monitor::Plugin::new();
    ...
    loop {
        ...
        sender.arbitrate(&mut alive);
sender.arbitrate(&mut system_monitor);
    }
}
